...
pub use driver::{
    ...
    ArduinoNiclaSenseMeTransport, DEFAULT_I2C_ADDRESS,
    RAW_REGISTER_LENGTH, RAW_REGISTER_START, RX_QUEUE_ID, SERIAL_BAUD, USB_PID, USB_VID,
    find_usb_port, list_usb_ports, prepare_port, read_dump,
