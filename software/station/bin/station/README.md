...
**Latest Release: [v0.1.0-beta.4](https://github.com/norma-core/norma-core/releases/tag/v0.1.0-beta.4)**

Download pre-built binaries from the [releases page](https://github.com/norma-core/norma-core/releases/tag/v0.1.0-beta.4):
